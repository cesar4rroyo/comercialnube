...
/**
* Incrustar respuesta de una ruta en un contenedor links
* @param  {string} ruta
* @param  {string} idContenedor
* @return {html}
*/
function cargarRutaLink(ruta, idContenedor, categoria, opcion) {
	$(".categs").removeClass("active");
	$(".opts").removeClass("active");

	$("#cat"+categoria).addClass("active");
	$("#opt"+opcion).addClass("active");
